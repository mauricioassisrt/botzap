...
import { EntityArrayResponseType, MensagemService } from '../service/mensagem.service';
...
export class MensagemComponent implements OnInit {
  ...
  trackId = (item: IMensagem): number => this.mensagemService.getMensagemIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.mensagems = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IMensagem[] | null): IMensagem[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.mensagemService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }

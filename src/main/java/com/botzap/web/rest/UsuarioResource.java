...
import com.botzap.service.UsuarioService;
...
/**
 * REST controller for managing {@link com.botzap.domain.Usuario}.
 */
@RestController
...
public class UsuarioResource {
    ...
    public Mono<List<Usuario>> getAllUsuarios() {
        ...
        return usuarioService.findAll().collectList();
    }
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<Usuario>> getUsuario(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteUsuario(@PathVariable("id") Long id) {

...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.botzap.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.botzap.security.DomainUserDetailsService", "createSpringSecurityUser");
